...
8. **CI / สี / ฟอนต์** ใช้ token จาก `app/src/ketshopweb-ds-tokens.css` (มาจาก `_ds` ของ mockup) ห้ามใส่สีดิบเพิ่ม · เรื่องสีแดง (ล็อก vs ปุ่มหลัก) ยังรอตัดสิน — อย่าเปลี่ยนเอง
